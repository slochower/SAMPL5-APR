...
def plot_dG(OAH_experiment=None, OAH_experiment_error=None, OAH_TIP3P=None, OAH_OPC=None, 
        ...
        ax.errorbar(OAH_experiment, OAH_TIP3P, yerr=OAH_T_err, xerr=OAH_experiment_error,  c=clrs[0], label='OAH, TIP3P',
                                        fmt='o', markersize=8, markeredgecolor='k', markeredgewidth=0.8, elinewidth=2, 
                    capsize=4, alpha=0.8, mfc=clrs[0], ecolor=clrs[0])
        ax.errorbar(OAH_experiment, OAH_OPC, yerr=OAH_O_err, xerr=OAH_experiment_error,  c=clrs[1], label='OAH, OPC',
                                        fmt='o', markersize=8, markeredgecolor='k', markeredgewidth=0.8, elinewidth=2, 
                    capsize=4, alpha=0.8, mfc=clrs[1], ecolor=clrs[1])
        ax.errorbar(OAMe_experiment, OAMe_TIP3P, yerr=OAMe_T_err, xerr=OAMe_experiment_error, c=clrs[2],  label='OAMe, TIP3P',
                                        fmt='o', markersize=8, markeredgecolor='k', markeredgewidth=0.8, elinewidth=2, 
                    capsize=4, alpha=0.8, mfc=clrs[2], ecolor=clrs[2])
        ax.errorbar(OAMe_experiment, OAMe_OPC, yerr=OAMe_O_err, xerr=OAMe_experiment_error, c=clrs[3], label='OAMe, OPC',
                                        fmt='o', markersize=8, markeredgecolor='k', markeredgewidth=0.8, elinewidth=2, 
                    capsize=4, alpha=0.8, mfc=clrs[3], ecolor=clrs[3])
        ...
        print(slope)
        print(intercept)
        ax.plot([i for i in np.arange(-20,20)], [slope*i+intercept for i in np.arange(-20,20)], ls='--', c=clrs[0], lw=1, alpha=1)
        slope, intercept, r_value, p_value, std_err = stats.linregress(data_combined, OPC_combined)
        print(slope)
        print(intercept)
        ax.plot([i for i in np.arange(-20,20)], [slope*i+intercept for i in np.arange(-20,20)], ls='--', c=clrs[1], lw=1, alpha=1)
...
def plot_TS(OAH_experiment_dH, OAH_experiment_TS, OAH_experiment_dH_error, OAH_experiment_TS_error,
        ...
        ax.plot([i for i in np.arange(-20,20)], [exp_slope*i+intercept for i in np.arange(-20,20)], ls='--', c=clrs[0], lw=1, alpha=1)
        
        T_slope, intercept, T_r_value, p_value, std_err = stats.linregress(T_TS_combined, T_dH_combined) 
        ax.plot([i for i in np.arange(-20,20)], [T_slope*i+intercept for i in np.arange(-20,20)], ls='--', c=clrs[1], lw=1, alpha=1)
        
        O_slope, intercept, O_r_value, p_value, std_err = stats.linregress(O_TS_combined, O_dH_combined) 
        ax.plot([i for i in np.arange(-20,20)], [O_slope*i+intercept for i in np.arange(-20,20)], ls='--', c=clrs[2], lw=1, alpha=1)
        ...
        ax.errorbar(OAH_experiment_TS[mask], OAH_experiment_dH[mask], yerr=OAH_experiment_dH_error[mask], xerr=OAH_experiment_TS_error[mask],
                    c=clrs[0], mfc=clrs[0], label=r'\makebox[2.3in][l]{{Exp, \hfill slope = {0:.2f},  R$^2$ = {1:.2f}}}'.format(exp_slope, exp_r_value**2),
                    fmt='o', markersize=8, markeredgecolor='k', markeredgewidth=0.8, elinewidth=2, capsize=4, alpha=0.8, )
        ...
        ax.errorbar(OAH_TIP3P_TS[mask], OAH_TIP3P_dH[mask], yerr=OAH_TIP3P_dH_error[mask], xerr=OAH_TIP3P_TS_error[mask],
                    c=clrs[1], mfc=clrs[1], label=r'\makebox[2.3in][l]{{TIP3P, \hfill slope = {0:.2f}, R$^2$ = {1:.2f}}}'.format(T_slope, T_r_value**2),
                    fmt='o', markersize=8, markeredgecolor='k', markeredgewidth=0.8, elinewidth=2, capsize=4, alpha=0.8, )
        ...
        ax.errorbar(OAH_OPC_TS[mask], OAH_OPC_dH[mask], yerr=OAH_OPC_dH_error[mask], xerr=OAH_OPC_TS_error[mask],
                    c=clrs[2], mfc=clrs[2], label=r'\makebox[2.3in][l]{{OPC, \hfill slope = {0:.2f}, R$^2$ = {1:.2f}}}'.format(O_slope, O_r_value**2),
                    fmt='o', markersize=8, markeredgecolor='k', markeredgewidth=0.8, elinewidth=2, capsize=4, alpha=0.8, )
